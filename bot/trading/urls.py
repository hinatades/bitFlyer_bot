...
urlpatterns = [
    ...
    path('getboard', views.GetBoardView.as_view(), name='board'),
    ...
    path('executions', views.Executions.as_view(), name='executions'),
    ...
    path('getchats', views.GetChatView.as_view(), name='getchats'),
]
